...
export default function OperatorEngineerCostsPage() {
  ...
  const stats = {
    total: data.length,
    low: data.filter((i: any) => Number(i.price) < 150000).length,
    medium: data.filter((i: any) => Number(i.price) >= 150000 && Number(i.price) < 300000).length,
    high: data.filter((i: any) => Number(i.price) >= 300000).length,
  };
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
        ...
        <Card className="border-none shadow-sm bg-blue-50">
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-bold uppercase opacity-60">&lt; 150rb</p>
        ...
        <Card className="border-none shadow-sm bg-amber-50">
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-bold uppercase opacity-60">150rb-300rb</p>
        ...
        <Card className="border-none shadow-sm bg-red-50">
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-bold uppercase opacity-60">&gt; 300rb</p>
